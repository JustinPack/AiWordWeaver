...
function update(win) {
  ...
  import_electron_updater.autoUpdater.on("update-available", (arg) => {
    win.webContents.send("update-can-available", { update: true, version: import_electron.app.getVersion(), newVersion: arg == null ? void 0 : arg.version });
  });
  import_electron_updater.autoUpdater.on("update-not-available", (arg) => {
    win.webContents.send("update-can-available", { update: false, version: import_electron.app.getVersion(), newVersion: arg == null ? void 0 : arg.version });
  });
